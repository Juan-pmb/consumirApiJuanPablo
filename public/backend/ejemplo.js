...
const registrarProveedor= () => {
    ...
    if(nombreProveedor.length == 0){
        document.getElementById('nombreHelp').value= 'Dato requerido'

    }
    else if(nit.length == 0){
        document.getElementById('NitHelp').value= 'Dato requerido'
    }
    else if(direccion.length == 0){
        document.getElementById('DireccionHelp').value= 'Dato requerido'
    }
    else if(correo.length == 0){
        document.getElementById('CorreoHelp').value = 'Dato requerido'
    }
    else if(nombreContacto.length == 0){
        document.getElementById('NombreContactoHelp').value = 'Dato requerido'
    }
    else if(numeroContacto.length == 0){
        document.getElementById('NumerocontactoHelp').value = 'Dato requerido'
    }
    else{
